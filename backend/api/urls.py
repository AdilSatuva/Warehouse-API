...
urlpatterns = [
    ...
    path('stock/transfers/', StockTransferListCreateView.as_view(), name='transfer_list_create'),
    path('stock/transfers/<int:pk>/', StockTransferDetailView.as_view(), name='transfer_detail'),
